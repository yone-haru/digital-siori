...
// ── Mobile Shell ─────────────────────────────────────────────────────────────
function MobileShell({ children, dark = false, style = {} }) {
  return (
    <div style={{
...
// ── Bottom Nav ────────────────────────────────────────────────────────────────
function BottomNav({ active = 'library', dark = false }) {
...
// ── Label (英字スモールキャップ風) ────────────────────────────────────────────
function Label({ children, style = {}, dark = false }) {
  return (
    <span style={{
      fontFamily: 'Zen Kaku Gothic New, sans-serif',
...
function BookCover({ title, author, publisher, color = '#2B3A2E', width = 88, height = 130, fontSize = 12 }) {
  return (
    <div style={{
      width, height,
      background: color,
...
Object.assign(window, { DS, StatusBar, MobileShell, BottomNav, Label, BookCover });
